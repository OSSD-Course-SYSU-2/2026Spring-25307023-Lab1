...
| 部分 | 内容 | 说明 |
|------|------|------|
| **HarmonyOS 项目** | 🔫 枪战训练营 + 📝 协作便签 | 华为 DevEco Studio 开发，演示一次开发多端部署与自由流转 |
| **任务一** | Node.js & npm 开发者生态探索 | Express + Axios + Chalk 项目，npm 依赖管理与生态系统分析 |
| **任务二** | Git 开发者生态探索 | Git 版本控制完整工作流，分支管理与内部原理 |

> 📖 任务一详情：[task1/task1.md](task1/task1.md)  
> 📖 任务二详情：[task2/task2.md](task2/task2.md)
...
├── task1/                                # 任务一：Node.js & npm 生态探索
│   ├── task1.md                           # 任务一详细文档
│   ├── index.js                           # Express REST API 服务器
...
### 2. HarmonyOS 项目：在 DevEco Studio 中打开
...
6. 点击工具栏 `Run` 按钮（或按 `Shift+F10`）

### 3. Lab1 任务：Node.js 项目

```bash
cd task1
npm install
node index.js          # 启动 Express 服务器
node cli-tool.js       # 运行 CLI 演示工具
```
...
```bash
cd task2
python hello-world.py  # 运行 Python 演示程序
```
